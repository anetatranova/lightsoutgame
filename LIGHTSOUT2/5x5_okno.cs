...
namespace LIGHTSOUT2
{
    public partial class _5x5_okno : Form
    {
        ...
        public _5x5_okno()
        {
            buttons = new Button[5, 5] { {btn_11,btn_12, btn_13, btn_14, btn_15 },
                { btn_21, btn_22, btn_23, btn_24, btn_25},
                { btn_31, btn_32, btn_33, btn_34, btn_35},
                {btn_41, btn_42, btn_43, btn_44, btn_45 },
                {btn_51, btn_52, btn_53, btn_54, btn_55 } };
        ...
        public void Start()
        {
            ...
            for (int i = 0; i < rnd.Next(4, velikost*velikost); i++)
            {
